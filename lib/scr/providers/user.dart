...
enum Status{Uninitialized, Authenticated, Authenticating, Unauthenticated,map}
...
//  getter
  ...
  Future addLocation({String userid,String location}){
    _userServicse.addLocation(userId: userid,location: location);
    notifyListeners();

  }
  getLocation({String userId})async{
    address = await _userServicse.getLocation(userId: userId);
    notifyListeners();
  }
