...
import 'package:food_course/scr/screens/googlemaps.dart';
...
import 'package:food_course/scr/screens/restaurantscreen.dart';
...
import 'package:food_course/scr/widgets/restaurantwidget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        ...
        // print( user.getLocation(userId: user.user.uid).toString());
        },
      ),
      appBar: AppBar(
        leading: GestureDetector(
          onTap: (){changeScreen(context,MyApp());},
          child: StreamBuilder(
            stream: FirebaseFirestore.instance.collection('users').where('uid',isEqualTo: user.user.uid).snapshots(),
            builder: (context,snapshot){
              if(!snapshot.hasData){
                return Text('pickLocation');
              }else{
                final List<DocumentSnapshot> documents = snapshot.data.docs;
                return ListView(
                  children: documents.map((doc)=>Text(doc['adrress'])).toList(),
                );
              }
            },
          ),
